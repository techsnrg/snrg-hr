	...
	create_custom_fields(
		{
			"Job Offer": [
				...
				},
				{
					...
					"label": "FY Short",
					"read_only": 1,
					"insert_after": "custom_company_code",
				},
				{
...
def _ensure_job_applicant_layout():
	...
	_ensure_property_setter("Job Applicant", "job_title", "hidden", "1", "Check")
	_ensure_property_setter("Job Applicant", "designation", "insert_after", "phone_number", "Data")
	_ensure_property_setter("Job Applicant", "job_opening", "insert_after", "designation", "Data")
	_ensure_property_setter("Job Applicant", "column_break_3", "hidden", "0", "Check")
	_ensure_property_setter("Job Applicant", "column_break_3", "insert_after", "job_opening", "Data")
	_ensure_property_setter("Job Applicant", "custom_full_address", "insert_after", "column_break_3", "Data")
	...
	_ensure_property_setter("Job Applicant", "column_break_18", "insert_after", "country", "Data")
	_ensure_property_setter("Job Applicant", "status", "insert_after", "column_break_18", "Data")
	_ensure_property_setter("Job Applicant", "currency", "insert_after", "status", "Data")
	...
	_ensure_property_setter("Job Applicant", "applicant_rating", "insert_after", "source_and_rating_section", "Data")
	_ensure_property_setter("Job Applicant", "source", "insert_after", "applicant_rating", "Data")
	...
	_ensure_property_setter("Job Applicant", "column_break_13", "hidden", "0", "Check")
	_ensure_property_setter("Job Applicant", "column_break_13", "insert_after", "employee_referral", "Data")
	_ensure_property_setter("Job Applicant", "notes", "insert_after", "column_break_13", "Data")
...
def _ensure_job_offer_defaults():
	...
	_ensure_property_setter("Job Offer", "custom_applicant_full_address", "hidden", "1", "Check")
