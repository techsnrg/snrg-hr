...
def _ensure_job_applicant_layout():
	...
	_ensure_property_setter("Job Applicant", "column_break_3", "hidden", "1", "Check")
	...
	_ensure_property_setter("Job Applicant", "section_break_6", "hidden", "0", "Check")
	...
	_ensure_property_setter("Job Applicant", "source", "insert_after", "source_and_rating_section", "Data")
	...
	_ensure_property_setter("Job Applicant", "column_break_13", "hidden", "1", "Check")
...
def _ensure_job_offer_defaults():
	...
	_ensure_property_setter("Job Offer", "offer_date", "insert_after", "applicant_name", "Data")
